...
class Saucedemo {
	...
	def ClickProduct() {
		WebUI.scrollToElement(findTestObject('Object Repository/Name Product', [('name') : 'Sauce Labs Bolt T-Shirt']), 0)
	...
	def fillFormInformation() {
		WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="first-name"]'), 'Nurul', FailureHandling.STOP_ON_FAILURE)
		WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="last-name"]'), 'nnn', FailureHandling.STOP_ON_FAILURE)
